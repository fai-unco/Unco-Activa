                    ...
                    <div className='py-5 text-sm'>
                        <div className="grid sm:grid-cols-2 px-5 lg:px-16">
                            <div className="sm:px-5">
                                ...
                                <h1 className='text-blue-dark text-[2rem] font-bold font-Hurme-Geometric-BO'>Requisitos de la carrera</h1>
                                ...
                                <p>
                                    *En un punto intermedio del recorrido y en la llegada se montarán puestos de asistencia e hidratación.<br></br>
                                    *A lo largo del recorrido se establecerán controles de paso de los corredores en donde habrá colaboradores con remeras.
                                </p>
                                ...
                                <p>La remera de corredor será de uso obligatorio con el número abrochado en el frente de la misma. Los participantes deben usar en el frente y visible de forma obligatoria el número otorgado por la organización, y el chip en el caso de utilizarlo como sistema de clasificación.</p>
                            </div>
                            ...
                            <div className="sm:px-5">
                                ...
                                <p>Se deberá enviar de manera obligatoria el comprobante de inscripción por email para poder acreditar el pago a <a href="#">uncoactiva@gmail.com</a> 
</p>
                            </div>
                        </div>
                    </div>
