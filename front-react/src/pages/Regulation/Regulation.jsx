            ...
            <div className="px-3 sm:px-5 lg:px-12">
              <div className="sm:px-5">
                ...
                <p className="font-bold">
                  SABADO 25 DE ABRIL - 15:00 HS
                </p>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  REGLAS GENERALES PARA LOS PARTICIPANTES
                </h4>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  Largada
                </h4>
                <p className="font-bold">
                  Gimnasio Polideportivo Roberto Monteros (Escondido)
                </p>
                <p className="font-bold">
                  Hora: 15:00hs
                </p>
                ...
                <p className="font-bold">
                  La modalidad de dicha carrera se va a dar en fomar individual.
                </p>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  Distancia
                </h4>
                <ul className='list-decimal pl-5 font-Header-Bd'>
                  <li className="pt-5 font-bold">
                    Prueba central: 15 Km
                  </li>
                  <li className="pt-5 font-bold">
                    Prueba central: 7 Km
                  </li>
                ...
                <p className="font-bold">
                  INDIVIDUAL (Edades computadas al día de la competencia)
                </p>
                <p className="font-bold pt-5">
                  CATEGORÍAS POR EDADES: 15Km
                </p>
                <ul className='list-decimal pl-5'>
                  <li className="pt-5">
                    MASCULINOS Y FEMENINOS HASTA 19 AÑOS
                  </li>
                  <li className="pt-5">
                    MASCULINOS Y FEMENINOS DE 20 A 29 AÑOS
                  </li>
                  <li className="pt-5">
                    MASCULINOS Y FEMENINOS DE 30 A 39 AÑOS
                  </li>
                  <li className="pt-5">
                    MASCULINOS Y FEMENINOS DE 40 A 49 AÑOS
                  </li>
                  <li className="pt-5">
                    MASCULINOS Y FEMENINOS DE 50 A 59 AÑOS
                  </li>
                  <li className="pt-5">
                    MASCULINOS Y FEMENINOS +60 AÑOS
                  </li>
                </ul>
                <h4 className="text-[1.1rem] text-red-500 pt-5 font-Header-B">
                  Nota Importante: Aquellos corredores que no cumplan 18 años a la fecha de la carrera, deberán presentar al momento de la acreditación una autorización de padre/madre o tutor para poder participar y copia de la ficha de inscripción firmada por el participante y por el padre/madre o tutor.
                </h4>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  B) PREMIACIÓN
                </h4>
                <p className='font-bold'>
                  Prueba de 15Km y 7Km
                </p>
                <ul className='list-decimal pl-5 font-bold'>
                  <li>
                    Medalla de Finalista a todos los que crucen la meta.
                  </li>
                  <li>
                    Medallones a los 1°, 2°, 3° de cada categoría masculina y femenina.
                  </li>
                </ul>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  C) REMERA DE LA COMPETENCIA Y NÚMERO IDENTIFICATORIO
                </h4>
                <p className='font-bold'>
                  La remera de corredor es de uso obligatorio, con el número abrochado al frente sin ocultar sus partes.
                </p>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                ...
                <ul className='list-decimal pl-5 font-bold'>
                  <li>
                    En puntos intermedios del recorrido y en la llegada se montará un puesto de asistencia e hidratación. (Solamente en 15Km)
                  </li>
                  <li>
                    A lo largo del recorrido se establecerán controles de paso de los corredores.
                  </li>
                </ul>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  E) PENALIDADES
                ...
                <ul className='list-decimal pl-5 font-bold'>
                  ...
                  <ul className='list-disc pl-5 font-bold'>
                    <li className='pt-5'>
                      1° Observación: Llamado de atención
                    </li>
                    <li className='pt-5'>
                      2° Observación: 10' de recargo
                    </li>
                    <li className='pt-5'>
                      3° Observación: Descalificación
                    </li>
                  </ul>
                  <li className='pt-5'>
                    Es obligatorio correr con la remera técnica entregada por la organización, por sobre cualquier prenda con el número completamente visible desde delante, estar sujeto por las cuatro esquinas y no debe ser cortado, doblado o escondido. La sanción por el inclumplimiento de este apartado será "el llamado de atención" y si no se rectifica, la descalificación.
                  </li>
                  <li className='pt-5'>
                    No cumplir con el recorrido oficial, obteniendo una ventaja, será motivo de descalificación.
                  </li>
                  <li className='pt-5'>
                    Está permitida la asistencia entre los corredores, excluyéndose cualquier forma que ayude en la marcha a otro corredor.
                  </li>
                </ul>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  F) REGLAS GENERALES PARA LOS PARTICIPANTES
                </h4>
                <p className='font-bold pt-2 pl-5'>
                  Los y las participantes deberán:
                </p>
                <ul className='list-decimal pl-5 font-bold'>
                  <li className='pt-5'>
                  ...
                  <li className='pt-5'>
                    Los competidores que acepten participar en este evento no tendrán derecho a realizar reclamos.
                  </li>
                  <li className='pt-5'>
                    Responsabilidades: Al inscribirse, el participante acepta el presente reglamento y declara:
                    <ul className='pl-5'>
                      <li>
                        a) Saber que habrá lugares a los que no se puede acceder con vehículos, con lo cual la atención médica inmediata es limitada.
                      </li>
                      <li>
                      ...
                      <li>
                        c) Eximir a los Organizadores, Municipios, Propietarios de las tierras del circuito de la carrera y los Patrocinantes de toda responsabilidad por accidentes personales; daños y/o pérdidas de objetos que pudiera ocurrirle antes, durante o después de su participación en la prueba.
                      </li>
                    </ul>
                  </li>
                </ul>
                <h4 className="text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B">
                  G) MARCACIÓN Y LIMPIEZA
                </h4>
                <ul className='pl-5 font-bold'>
                  <li>
                    La marcación del circuito se realiza con cinta de color azul con logo propio (no
                    ...
                    también los puestos de agua que poseen bolsas de residuos.
                  </li>
                </ul>
                <h4 className='text-[1.2rem] text-blue-cyan font-bold pt-5 font-Header-B'>
                  H) COMUNICACIÓN
                ...
                <ul className='pl-5 font-bold'>
                  <li>
                    Se considera como medio oficial de comunicación de novedades la página. El participante deberá consultar periódicamente el sitio a fin de estar al tanto de novedades y posibles modificaciones en el.
                  </li>
                </ul>
              </div>
            </div>
