...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center font-Text-R px-3 md:px-12 pb-7 gap-5">
            ...
            <div className="flex flex-col px-5 lg:px-16 gap-4">
              <div className="text-blue-cyan text-lg sm:text-xl font-bold font-Text-R">
                <p>
                  ...
                  carácter competitivo, sino también por su enfoque en la salud
                  y el bienestar de todos los participantes. Esta iniciativa
                  refleja el compromiso de la Universidad con la promoción de un
                  estilo de vida activo y saludable, alineándose con los
                  objetivos del área de deportes y recreación de nuestra
                  Institución.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <p>
                  Gran parte del recorrido se realiza en el Área Protegida
                  Parque Universitario Provincia del Monte. Este parque fue
                  creado mediante la ordenanza Nº 714/2004 del Consejo Superior
                  de la Universidad Nacional del Comahue. Ocupa un área de 70 ha
                  en la parte norte de los terrenos del campus de nuestra
                  institución en la ciudad de Neuquén.
                </p>
                <p>
                  Participar en la carrera UNCo Activa no solo brinda la
                  oportunidad de disfrutar de una jornada de ejercicio al aire
                  libre, sino que también fomenta la integración y el
                  compañerismo entre los miembros de la Comunidad Universitaria
                  y la Comunidad en General. Es un espacio donde se celebra el
                  esfuerzo personal y colectivo, promoviendo valores como la
                  perseverancia, la disciplina y el trabajo en equipo.
                </p>
                <p>
                  ...
                  particular y el resto de la comunidad. Al incentivar la
                  práctica del trote y el senderismo, se busca no solo mejorar
                  la condición física, sino también reducir el estrés y mejorar
                  la salud mental.
                </p>
              </div>
              ...
              <div className="flex flex-col font-bold font-Text-R text-blue-cyan gap-4">
                <p>
                  ...
                  relación con el área de deportes y recreación de la
                  Universidad Nacional del Comahue resalta la importancia de
                  fomentar hábitos saludables y crear un ambiente inclusivo
                  donde todos puedan disfrutar de los beneficios del ejercicio.
                </p>

                <p>
                  ¡Así que a calzarse las zapatillas y a correr, trotar o
                  caminar juntos por una vida activa, siempre en Defensa de la
                  Universidad Pública!
                </p>
              </div>
            </div>
      ...
      <div
        id="information"
        className="rounded-lg bg-gray-light text-black-unco grid items-center justify-center p-10 gap-3"
      >
          ...
          <div className="flex flex-col lg:flex-row items-center w-full">
            ...
            <div className="flex flex-col items-center p-5 gap-5 lg:w-2/3">
              ...
              <p className="pt-2 font-bold">
                A los participantes que hayan completado la inscripción y el
                pago, pero decidan posteriormente no participar en la carrera,
                no se les reembolsará el importe abonado.
              </p>
      ...
      <div className="flex flex-col w-full xl:flex-row gap-5">
        ...
        <div
          id="organizers"
          className="bg-gray-light rounded-lg justify-center items-center gap-5 w-full"
        >
          <div className=" text-black-unco p-10">
            <div className="grid justify-center">
              ...
              <div className="grid grid-cols-3  items-center justify-center p-5">
                <img
                ...
                <img
                  ...
                  src={
                    "/logos/unco/Secretaría de Bienestar Universitario-01.png"
                  }
                />
              </div>
            </div>
