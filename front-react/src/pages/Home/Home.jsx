...
const Home = () => {
  ...
  return (
    <div className="font-Hurme-Geometric-R min-h-screen">
        ...
        <div className=" bg-gray-light rounded-lg text-black">
          ...
          <div className="py-5">            
            ...
            <div className="px-5 sm:px-5 lg:px-16 pt-10">
              <div className="text-[1.8rem] text-center p-5 font-Hurme-Geometric-BO text-blue-cyan">
              ...
              <ul className="list-disc pl-5">
                <p className="font-bold">Comunidad en general:</p>
                <li>15 km $55000.</li>
                <li>7 km $50000.</li>
                <li>3 km $40000. </li>
                <br />
          ...
          <div className="grid justify-center pb-5">
            <h1
              className="text-center text-[2rem]  md:text-[2.5rem] font-Hurme-Geometric-BO text-blue-dark"
              fill="currentColor"
            >
              Organizadores
            </h1>
      ...
      <div className="px-12 py-7 rounded-lg">
        <RacePath />
      </div>
