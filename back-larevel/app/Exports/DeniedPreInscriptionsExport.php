...
class DeniedPreInscriptionsExport implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping
{
    use Exportable;
    ...
    public function __construct()
    {
        ...
        if (!file_exists($path)) {
            Log::warning('DeniedPreInscriptionsExport: no se encontró sorted_dnis.json en storage/app');
            $this->lookup = [];
            return;
        }
    ...
    public function collection()
    {
        ...
        ->whereNotNull('verification_denied')
        ->get([
            'inscriptions.id',
