...
# Hola {{ $datos['name'] }}! muchas gracias por preinscribirte en la carrera de la UNCO.
    ---
...
## Recuerde que de no enviarse el comprobante de pago a través de la aplicacion web, no se considerará como inscripto. 
