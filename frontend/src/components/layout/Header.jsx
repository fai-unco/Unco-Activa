...
function Header() {
    ...
    return (
        <header className='App-header z-50 sticky top-0 opacity-90'>
            <nav className="bg-white  border-gray-light px-4 lg:px-1 py-2.5 lg:py-0 w-full dark:bg-gray-darker absolute">
